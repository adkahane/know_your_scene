...
var orm = {
  ...
  // Select all bands from a state
  selectAllWhere: function(tableInput, searchInput, cb) {
    var queryString = "SELECT * FROM " + tableInput + " WHERE band.band_state ='" + searchInput + "';";
    connection.query(queryString, function(err, result) {
      if (err) {
        throw err;
      }
